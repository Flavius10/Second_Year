...
public class LoginController {
    ...
    public void setService(ServiceUser service, ServiceCoins coins, ServiceTransaction serviceTransaction) {
        this.service = service;
        this.serviceCoins = coins;
    ...
    private void openWindow(String fxml, String title, User user) {
        try {
            ...
            if (ctrl instanceof AdminController) {
                ((AdminController) ctrl).setService(service, serviceCoins, serviceTransaction, user);
            }
            else{
                ((TraderController) ctrl).setService(service, serviceCoins, serviceTransaction, user);
            }
