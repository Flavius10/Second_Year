...
(defun maxim (L M)
	(cond 
		((NULL L) M)
		((and (not (listp (car L))) (> (car L) M)) (maxim (cdr L) (car L)))
		((listp (car L)) (maxim (cdr L) (maxim (car L) M)))
		((and (not (listp (car L))) (<= (car L) M)) (maxim (cdr L) M))
	)
)
...
;; din Lista_originala il stergem elementul ala si dupa facem permutarile la
